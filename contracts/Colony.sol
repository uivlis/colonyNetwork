...
contract Colony is ColonyStorage, PatriciaTreeProofs {
  ...
  bytes4 constant SIG_D0 = bytes4(keccak256("setExtensionManager(address"));
  bytes4 constant SIG_D1 = bytes4(keccak256("addExtension(bytes32,address,uint8[])"));
  bytes4 constant SIG_D2 = bytes4(keccak256("setUserRoles(uint256,uint256,address,uint256,bytes32,bool)"));
